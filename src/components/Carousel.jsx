                        ...
                        return <div key={index} className='bg-gradient-to-r from-[#0f0c29] via[#302b63] to-[#24243e] -z-10'>
                            <div className='flex flex-col md:flex-row gap-10 justify-center h-[600px] items-center px-4 my-20 md:my-0'>
                                <div className='md:space-y-6 space-y-3'>
                                    ...
                                    <button className='bg-gradient-to-r from-red-500 to-purple-500 text-white px-3 py-2 rounded-md cursor-pointer mt-2' onClick={() => navigate('/products')}>Shop Now</button>
                                </div>
                                <div>
